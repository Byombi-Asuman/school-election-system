...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('LOGIN', 'LOGOUT', 'CREATE', 'UPDATE', 'DELETE', 'APPROVE', 'REJECT', 'VOTE', 'EXPORT', 'IMPORT', 'SETTINGS_CHANGE', 'PASSWORD_RESET', 'OTP_GENERATE', 'OTP_VERIFY');
...
CREATE TABLE "Position" (
    ...
    "maxContestants" INTEGER NOT NULL DEFAULT 10,
...
CREATE TABLE "VotingOtp" (
    ...
    CONSTRAINT "VotingOtp_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "VotingOtp_studentId_code_idx" ON "VotingOtp"("studentId", "code");
...
-- AddForeignKey
ALTER TABLE "VotingOtp" ADD CONSTRAINT "VotingOtp_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE ON UPDATE CASCADE;
